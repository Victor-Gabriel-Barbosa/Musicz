...
export const AnimatedThemeToggler = ({
  ...
  if (!mounted) {
    return (
      <button
        type="button"
        className={cn(
          "inline-flex items-center justify-center h-9 w-9 rounded-md transition-colors opacity-50 cursor-pointer",
          className,
        )}
        disabled
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "inline-flex items-center justify-center h-9 w-9 rounded-md transition-colors hover:bg-sidebar-accent text-sidebar-foreground cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
        className,
      )}
      aria-label="Alternar tema"
      {...props}
